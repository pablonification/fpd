  ...
  return (
    <div ref={dropdownRef} className="relative select-none">
      ...
      <button
        ...
        className="cursor-pointer flex w-max min-w-[140px] items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:border-[#2AB2C7] hover:bg-gray-50 active:scale-95"
